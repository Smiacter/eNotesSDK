...
//            [Alert showWithLeftTxt:nil rightTxt:NSLocalizedString(@"Confirm", nil) msg:NSLocalizedString(@"AlbumAccessLimited", nil) title:NSLocalizedString(@"TitleTip", nil) cancelClosure:nil confirmClosure:nil];//[self enterImagePickerController];
        } else if (status == PHAuthorizationStatusRestricted) {
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"TitleTip", nil) message:NSLocalizedString(@"AlbumAccessLimited", nil) preferredStyle:(UIAlertControllerStyleAlert)];
